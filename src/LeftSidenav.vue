<template lang="html">
  <el-menu theme="dark" class="el-menu-demo" mode="horizontal">
    <el-menu-item index="1"><a href="/#/posts">All Posts</a></el-menu-item>
    <el-menu-item index="2"><a href="/#/posts/new">New Posts</a></el-menu-item>
    ...
    <md-sidenav class="md-left" ref="leftSidenav">
      <md-toolbar class="md-large">
        ...
        <md-list>
          ...
          <md-list-item>
            <md-button class="md-raised md-primary" @click.native="logOut">
              <span>Log out</span>
            </md-button>
          </md-list-item>
        </md-list>
